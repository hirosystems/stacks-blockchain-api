...
function parseDbBlock(
  ...
  const apiBlock: Block = {
    ...
    hash: dbBlock.block_hash,
    stacks_block_time:
      dbBlock.stacks_block_time > 0 ? dbBlock.stacks_block_time : dbBlock.burn_block_time,
    stacks_block_time_iso:
      dbBlock.stacks_block_time > 0
        ? unixEpochToIso(dbBlock.stacks_block_time)
...
function parseDbAbstractTx(dbTx: DbTx, baseTx: BaseTransaction): AbstractTransaction {
  const abstractTx: AbstractTransaction = {
    ...
    stacks_block_time: dbTx.stacks_block_time || dbTx.burn_block_time,
    stacks_block_time_iso: dbTx.stacks_block_time
      ? unixEpochToIso(dbTx.stacks_block_time)

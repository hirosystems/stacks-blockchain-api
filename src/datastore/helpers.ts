...
export function parseTxQueryResult(result: ContractTxQueryResult): DbTx {
  const tx: DbTx = {
    ...
    stacks_block_time: result.stacks_block_time || result.burn_block_time,
...
export function parseBlockQueryResult(row: BlockQueryResult): DbBlock {
  ...
  const block: DbBlock = {
    ...
    stacks_block_time: row.stacks_block_time || row.burn_block_time,
...
export function createDbTxFromCoreMsg(msg: CoreNodeParsedTxMessage): DbTxRaw {
  ...
  const dbTx: DbTxRaw = {
    ...
    stacks_block_time: msg.stacks_block_time,

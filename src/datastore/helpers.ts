...
export function parseTxQueryResult(result: ContractTxQueryResult): DbTx {
  const tx: DbTx = {
    ...
    stx_transfer_event_count: result.stx_transfer_event_count,
    stx_mint_event_count: result.stx_mint_event_count,
    stx_burn_event_count: result.stx_burn_event_count,
    stx_lock_event_count: result.stx_lock_event_count,
    ft_transfer_event_count: result.ft_transfer_event_count,
    ft_mint_event_count: result.ft_mint_event_count,
    ft_burn_event_count: result.ft_burn_event_count,
    nft_transfer_event_count: result.nft_transfer_event_count,
    nft_mint_event_count: result.nft_mint_event_count,
    nft_burn_event_count: result.nft_burn_event_count,
    contract_log_event_count: result.contract_log_event_count,

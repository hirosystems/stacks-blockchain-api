...
describe('Rosetta API', () => {
  ...
  beforeAll(async () => {
    ...
    await compose.buildOne('rosetta-cli', {
      ...
      log: true,
<<<<<<< HEAD:src/tests-rosetta-cli-data/validate-rosetta.ts
      composeOptions: [
        '-f',
...
>>>>>>> parent of f764054c (feat: rosetta data api and construction validation with rosetta-cli):src/tests-rosetta-cli/validate-rosetta.ts
    });
    // start cli container

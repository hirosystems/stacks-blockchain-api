    ...
    expect(JSON.parse(query1.text)).toEqual({
      ...
      allow: {
        ...
        errors: [
          ...
          { code: 621, message: 'Invalid transaction type', retriable: false },
          { code: 622, message: 'Invalid sender address', retriable: false },
          { code: 623, message: 'Invalid recipient address', retriable: false },

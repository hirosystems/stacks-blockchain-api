...
describe('postgres datastore', () => {
  ...
  test('pg address FT balances', async () => {
    ...
    const tx: DbTxRaw = {
      ...
      stacks_block_time: dbBlock.burn_block_time,
  ...
  test('pg mempool tx lifecycle', async () => {
    ...
    const tx1: DbTxRaw = {
      ...
      stacks_block_time: block3B.burn_block_time,
  ...
  test('pg reorg orphan restoration', async () => {
    ...
    const tx1: DbTxRaw = {
      ...
      block_height: block1.block_height,
      stacks_block_time: block1.burn_block_time,
    ...
    const tx2: DbTxRaw = {
      ...
      stacks_block_time: block2.burn_block_time,
  ...
  test('pg reorg handling', async () => {
    ...
    const tx1: DbTxRaw = {
      ...
      block_hash: block1.block_hash,
      block_height: block1.block_height,
      stacks_block_time: block1.block_height,
      burn_block_time: block1.burn_block_time,
      parent_burn_block_time: 1626122935,
      type_id: DbTxTypeId.Coinbase,
      status: 1,
    ...
    const tx3: DbTxRaw = {
      ...
      stacks_block_time: block2b.burn_block_time,
